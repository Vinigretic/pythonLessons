...
# то напечатать "Ладьи были активнее".
...
# 2. Единицы массы пронумерованы следующим образом: 1 — грамм, 2 — килограмм, 3 — центнер, 4 — тонна. Дан номер единицы массы n (целое число в диапазоне 1–4) и масса тела m в этих единицах (вещественное число). Найти массу тела в килограммах.
#
...
# 1. Мы получаем список от пользователя вида spisok = [5, 0, -1, 3, -2, 10, -12, 20, 7]. Вывести все положительные числа кратные 5 через запятую.
# 2. Мы получаем список от пользователя вида spisok = [5, 0, -1, 3, -2]. Вывести наименьшее положительное число в списке.
# 3. Написать программу, которая находит в списке spisok = [5, 4, -1, 0, -2, 0, 5, 4, 4, 7] число, которое встречается наибольшее количество раз.
#
# ДЗ, добавка:
...
# 2. Написать программу которая подсчитывает количество цифр в строке "Олимпиада в Сочи была в 2014 году" и их сумму. Вывод должен быть "В строке цифр: X, сумма этих цифр: Y"
...
# 2. Даны целые положительные числа A и B (A < B). Вывести все целые числа от A до B включительно; при этом каждое число должно выводиться с новой строки столько раз, каково его значение.
# Например:
# a = 2
# b = 4
# 22
...
# 3. У нас есть колода карт с мастями (♥♦♠♣) и карты от шестёрки до туза. Сформировать колоду вида: 6♦, 6♥, 6♠, 6♣ ... Т♣. Перемешать её и вывести первые случайные 6 карт.
# masti = '♥♦♠♣'
# number = ['6', '7', '8', '9', '10', 'В', 'Д', 'К', 'Т']
# Можно ли решить задачу в одну строку?
#
# 4. Пользователь через пробел вводит целые числа в диапазоне [-20;20]. Найти произведение тех чисел, которые находятся в диапазоне [2;10], если таких чисел нет - вывести "-1".
# Пример:
# 13 -1 0 1   -> -1
# 3 4 14 -1   -> 12
